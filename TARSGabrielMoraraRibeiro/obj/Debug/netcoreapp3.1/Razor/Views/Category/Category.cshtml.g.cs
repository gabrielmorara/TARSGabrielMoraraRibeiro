#pragma checksum "C:\Users\gabri\Desktop\PROJETOS\Tars\TARSGabrielMoraraRibeiro\TARSGabrielMoraraRibeiro\Views\Category\Category.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "6f13a624c81e1aa43349ad8ef10c679ebe49edaa"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"6f13a624c81e1aa43349ad8ef10c679ebe49edaa", @"/Views/Category/Category.cshtml")]
...
#nullable restore
#line 9 "C:\Users\gabri\Desktop\PROJETOS\Tars\TARSGabrielMoraraRibeiro\TARSGabrielMoraraRibeiro\Views\Category\Category.cshtml"
...
<table id=""table-categorys"" cellspacing=""0"" class=""table table-striped table-bordered table-condensed"">
   ...
   ");
            WriteLiteral(@"         <td>
                <input type=""text"" name=""nameInput"" class=""form-control"" data-bind=""attr: { id: 'nameInput_' + categoryID() }, value: name, text: name"" disabled />
            </td>
    ...
    function ViewModel() {
        try {
            ...
            self.createdCategory = () => {
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        self.features.unshift(new FeatureRequest(respon");
            WriteLiteral(@"se));
            ...
            self.saveEditCategory = (value) => {
                console.log(value);
                $('#nameInput_' + value.categoryID()).attr");
                    ...
                    success: function (response) {
                        ...
                        $(""#table-categorys"").DataTable({
                            ...
                            language: {
                                ...
                                ""sZeroRecords"":");
            WriteLiteral(@" ""Não foram encontrados registros"",
